        ...
        <div className='w-[70%] flex justify-end items-center'>
          ...
          <form action="">
            <div className='relative w-[350px] ml-8'>
              <input type="text" className='h-[48px] w-full bg-[#F9FAFB] border border-gray-300 rounded focus:outline-[#EE4736] pl-[10px] pr-[85px]'/>
              <button className='absolute top-[50%] translate-y-[-50%] h-[70%] right-[8px] bg-[#EE4736] hover:bg-[#CB3C2E] text-white font-medium text-base px-3 rounded duration-300'>Search</button>
            </div>
          </form>
        </div>
      </header>
